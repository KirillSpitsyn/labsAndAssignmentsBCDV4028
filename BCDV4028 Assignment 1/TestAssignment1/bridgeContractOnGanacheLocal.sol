...
contract bridgeContractGanache {
    // Address of my wallet on Ganache local testnet
    address public wallet;

    // My token that will be bridged to Sepolia network
    IERC20 public tokenTTA;

    // Token that will be bridged to this Ganache local network
    ...
    constructor(address _wallet, address _tokenTTA) {
        wallet = _wallet;
        tokenTTA = IERC20(_tokenTTA);
    }
